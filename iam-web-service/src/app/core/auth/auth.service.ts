...
export class AuthService {
  private readonly AUTH_URL = 'http://localhost:8888/ms-internal-iam/auth/authorize';
  private readonly TOKEN_URL = '/api/auth/token';
  private readonly LOGOUT_URL = 'http://localhost:8888/ms-internal-iam/auth/logout';
  private readonly CLIENT_ID = 'iam-demo-portal';
  ...
  logout() {
    ...
    try { localStorage.setItem('_iam_logout', Date.now().toString()); } catch {}
    if (token) {
