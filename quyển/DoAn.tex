...
% Overleaf: xóa dòng trên, dùng 2 dòng sau:
...
% === Chương hướng dẫn của template — đã xóa khỏi bản cuối ===
% \newpage
...
\titlecontents{chapter}
    ...
    {}         % unnumbered format
    {\titlerule*[0.3pc]{.}\contentspage}         % filler-page-format, e.g dots
% === Phụ lục hướng dẫn của template — đã xóa khỏi bản cuối ===
% \chapter{HƯỚNG DẪN VIẾT ĐỒ ÁN TỐT NGHIỆP}
% \subfile{Chuong/Phu_luc_A}
\newpage
\chapter{MÔ TẢ ỨNG DỤNG MINH HỌA}
