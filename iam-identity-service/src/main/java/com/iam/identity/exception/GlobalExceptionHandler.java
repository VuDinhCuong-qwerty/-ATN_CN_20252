...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<?>> handleMethodArgumentNotValid(
        ...
        log.warn("Validation failed [{}]: {}", request.getRequestURI(), detail, ex);
        return ResponseEntity.badRequest().body(
                ApiResponse.error(ErrorCode.VALIDATION_FAILED.getCode(), detail, request.getRequestURI()));
    }

    // ── @Validated trên method / controller params ────────────────────────────
    ...
    public ResponseEntity<ApiResponse<?>> handleConstraintViolation(
        ...
        String detail = ex.getConstraintViolations().stream()
                ...
                .collect(Collectors.joining("; "));
        log.warn("ConstraintViolation [{}]: {}", request.getRequestURI(), detail, ex);
        return ResponseEntity.badRequest().body(
                ApiResponse.error(ErrorCode.VALIDATION_FAILED.getCode(), detail, request.getRequestURI()));
    }
    ...
    public ResponseEntity<ApiResponse<?>> handleMissingParam(
        ...
        log.warn("Missing param [{}]: {}", request.getRequestURI(), detail, ex);
        return ResponseEntity.badRequest().body(
                ApiResponse.error(ErrorCode.VALIDATION_FAILED.getCode(), detail, request.getRequestURI()));
    }
    ...
    public ResponseEntity<ApiResponse<?>> handleTypeMismatch(
        ...
        log.warn("Type mismatch [{}]: {}", request.getRequestURI(), detail, ex);
        return ResponseEntity.badRequest().body(
                ApiResponse.error(ErrorCode.VALIDATION_FAILED.getCode(), detail, request.getRequestURI()));
    }
    ...
    public ResponseEntity<ApiResponse<?>> handleNotReadable(
        ...
        log.warn("Malformed JSON [{}]: {}", request.getRequestURI(), ex.getMessage(), ex);
        return ResponseEntity.badRequest().body(
                ApiResponse.error(ErrorCode.VALIDATION_FAILED.getCode(),
    ...
    public ResponseEntity<ApiResponse<?>> handleAccessDenied(
        ...
        log.warn("Access denied [{}]: {}", request.getRequestURI(), ex.getMessage(), ex);
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(
                ApiResponse.error(HttpStatus.FORBIDDEN.value(),
                        ErrorCode.FORBIDDEN.getCode(),
                        ErrorCode.FORBIDDEN.getDesc(),
                        request.getRequestURI()));
    }
    ...
    public ResponseEntity<ApiResponse<?>> handleBusinessException(
        ...
        log.error("BusinessException [{}]: {}", request.getRequestURI(), ex.getMessage(), ex);
        return ResponseEntity.badRequest().body(
